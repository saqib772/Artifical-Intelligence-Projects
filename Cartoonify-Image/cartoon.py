...
# confirm that image is chosen
    ...
    ReSized2 = cv2.resize(grayScaleImage, (960, 440))
    plt.imshow(ReSized2, cmap='gray')

    # Step 5: Smoothening a grayscale image
    #applying median blur to smoothen an image
    smoothGrayScale = cv2.medianBlur(grayScaleImage, 5)
    ReSized3 = cv2.resize(smoothGrayScale, (960, 440))
  ...
  cv2.THRESH_BINARY, 9, 9)
    ...
    fig, axes = plt.subplots(3,2, figsize=(6,2), subplot_kw={'xticks':[], 'yticks':[]}, gridspec_kw=dict(hspace=0.1, wspace=0.1))
